...
[lien vers le code source]: https://github.com/Microsoft/vcpkg	"github vcpkg"
...
[example]: https://github.com/Microsoft/vcpkg/blob/master/docs/examples/using-sqlite.md	"un example d'utilisation de vcpkg"
